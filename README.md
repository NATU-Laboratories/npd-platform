...
| Departamentos | Tarjeta por departamento con estados configurables en el backoffice (stepper con fechas, días en el estado y rondas; avanzar/retroceder con comentario, actividad y aviso; el estado final completa su parte) y datos plegables en «Ver detalles». Widget en el panel con proyectos por estado de cada departamento. |
