...
const design: TaskDef[] = [
  ...
  { key: "a6", phase: 4, dept: "comunicacion", title: "Traducciones", deps: ["a5"], days: 5 },
  { key: "a7", phase: 4, dept: "comercial", title: "Aprobación AAFF por el cliente", deps: ["a6"], days: 5 },
];
const production: TaskDef[] = [
  { key: "p1", phase: 5, dept: "compras", title: "Compra de materiales y envases", days: 20 },
  { key: "p2", phase: 5, dept: "operaciones", title: "Escandallo final", days: 3 },
  { key: "p3", phase: 5, dept: "calidad", title: "Documentación técnica", days: 5 },
  { key: "p4", phase: 5, dept: "operaciones", title: "Documentación logística", days: 3 },
...
const TEMPLATES: { name: string; appliesTo: { types?: string[]; subtypes?: string[]; categories?: string[] }; tasks: TaskDef[] }[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { key: "d2", phase: 3, dept: "marketing", title: "Elección de envase", days: 5 },
      { key: "d3", phase: 3, dept: "idi", title: "Compatibilidad envase-fórmula", deps: ["d2"], days: 15 },
      ...design,
      ...production,
    ],
  },
